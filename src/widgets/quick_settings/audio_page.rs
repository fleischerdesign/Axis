...
use crate::services::audio::{AudioCmd, AudioData, SinkInputData};
...
impl HasComboEntry for crate::services::audio::SinkData {
    fn description(&self) -> &str {
        &self.description
    }
    fn is_default(&self) -> bool {
...
impl HasComboEntry for crate::services::audio::SourceData {
    fn description(&self) -> &str {
        &self.description
    }
    fn is_default(&self) -> bool {
